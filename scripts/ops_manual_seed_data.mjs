  ...
  entries: [
    {
      ...
      search_text: '새 내용 알려주는 방법 새 소식 전달 정리 같은 주제 묶기',
      source: OPS_MANUAL_SEED_SOURCE,
    ...
    },
    {
      ...
      search_text: '근무 변경 요청 방법 날짜 직원 시간 휴무',
      source: OPS_MANUAL_SEED_SOURCE,
    ...
    },
    {
      ...
      search_text: '행사 안내 기준 적용 기간 대상 예외 재안내 보류',
      source: OPS_MANUAL_SEED_SOURCE,
    ...
    },
    {
      ...
      search_text: '배달정보 확인 기준 주소 건물명 호수 비밀번호 확인 경로',
      source: OPS_MANUAL_SEED_SOURCE,
    ...
    },
    {
      ...
      search_text: '할일 알림 등록 방법 마감 반복 담당자',
      source: OPS_MANUAL_SEED_SOURCE,
    ...
    },
    {
      ...
      search_text: '배민 주문 변경 안내 취소 재주문 고객센터 가맹점',
      source: OPS_MANUAL_SEED_SOURCE,
      source_urls: [
    ...
    },
    {
      ...
      search_text: '쿠팡이츠 주문 변경 안내 수락 전 거절 처리중 취소 재주문 품절',
      source: OPS_MANUAL_SEED_SOURCE,
      source_urls: [
    ...
    },
    {
      ...
      search_text: 'BBQ 앱 주문 변경 취소 콜센터 제품 구성 가격',
      source: OPS_MANUAL_SEED_SOURCE,
      source_urls: [
    ...
    },
    {
      ...
      search_text: 'BBQ 쿠폰 사용 안내 등록 장바구니 사용 가능 금액 조건',
      source: OPS_MANUAL_SEED_SOURCE,
      source_urls: [
        'https://bbq.co.kr/mypage/guide',
    ...
    },
    {
      ...
      search_text: '주문 변경 응대 기준 플랫폼 상태 취소 재주문 고객센터 매장 확인',
      source: OPS_MANUAL_SEED_SOURCE,
      source_urls: [
        'https://help.naver.com/service/30026/contents/20534?lang=ko',
        'https://ceo.baemin.com/guide/4268',
