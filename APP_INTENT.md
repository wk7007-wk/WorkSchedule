...
- 사용자 1차 calendar UI 대상은 별도 consumer인 `/root/my-first-project/AttendanceBoard/docs/hynix`다. source adapter는 구현됐지만 `CALENDAR_SYNC_CONTRACT.md`에 따른 live 배포, 전용 Google OAuth 연결, worker 물리 검증 전에는 사용자-facing 완료로 보지 않는다.
